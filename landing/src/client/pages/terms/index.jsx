  ...
  render(props) {
    return (
      <PrivacyLayout>
        ...
        <p>
          <span className={styles.chapter}>2.3. Access to Services.</span>
        ...
        <p>
          <span className={styles.chapter}>2.6. Contractors and Affiliates.</span>
        ...
        <p>
          <span className={styles.chapter}>2.7. General Restrictions.</span>
        ...
        <p>
          <span className={styles.chapter}>3.3. Customer Obligations.</span>
        </p>
        ...
        <p>
          <span className={styles.chapter}>7.2. Fees and Payment.</span>
        ...
        <p>
          <span className={styles.chapter}>7.3. Payment Via Credit Card.</span>
        ...
        <ol>
          ...
          <li>
            <span className={styles.listTitle}>Foreign Transaction Fees.</span>
        ...
        <p>
          {'a)'}
          <span className={styles.listTitle}>Direct Dispute Resolution.</span>
        ...
        <p>
          {'c)'}
          <span className={styles.listTitle}>Choice of Law and Jurisdiction.</span>
        ...
        <p>
          {'d)'}
          <span className={styles.listTitle}>Construction and Joinder.</span>
